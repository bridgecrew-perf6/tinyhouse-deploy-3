...
exports.listingResolvers = {
    ...
    Mutation: {
        hostListing: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const newListing = Object.assign(Object.assign({ _id: new mongodb_1.ObjectId() }, input), { image: imageUrl, bookings: [], bookingsIndex: {}, country,
                admin,
                city, host: viewer._id, authorized: true });
    ...
    Listing: {
        ...
        _args, { db }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        bookings: (listing, { limit, page }, { db }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                cursor = cursor.skip(page > 0 ? (page - 1) * limit : 0);
                cursor = cursor.limit(limit);
                data.total = yield db.bookings.countDocuments({ _id: { $in: listing.bookings } });
                data.result = yield cursor.toArray();
                return data;
            }
            catch (error) {
