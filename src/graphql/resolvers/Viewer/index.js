...
const logInViaGoogle = (code, token, db, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!viewer) {
        ...
        yield db.users.insertOne(newUser);
        viewer = newUser;
    }
    res.cookie("viewer", userId, Object.assign(Object.assign({}, cookieOptions), { maxAge: 365 * 24 * 60 * 60 }));
    return viewer;
});
...
exports.viewerResolvers = {
    ...
    Mutation: {
        ...
        disconnectStripe: (_root, 
        // eslint-disable-next-line @typescript-eslint/ban-types
        _args, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                let viewer = yield (0, utils_1.authorize)(db, req);
                if (!viewer) {
                    throw new Error("viewer cannot be found");
                }
                const updateRes = yield db.users.findOneAndUpdate({ _id: viewer._id }, { $unset: { walletId: "" } }, { returnDocument: "after" });
                if (!updateRes.value) {
                    throw new Error("viewer could not be updated");
                }
                viewer = updateRes.value;
